...
from flpfinisher.validate.validator import validate_derivative
from flpfinisher.write.flp_writer import WriteUnsupported, write_arrangement
...
class _Recorder:
    ...
    def begin(self, name: str) -> None:
        if self.progress:
            self.progress(name, StageStatus.RUNNING.value, "")
...
def build(
    ...
    *,
    ...
    if options.want_wav or options.want_mp3:
        recorder.begin("Rendering audio")
